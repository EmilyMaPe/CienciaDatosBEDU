...
# Acontinuación, mostramos el clasificador de vectores de soporte junto con las
# observaciones. Los vectores de soporte se muestran como $x's$
...
# También podemos observar los índices (números de filas en el data frame) que 
# corresponden a vectores de soporte
...
# El siguiente comando indica que queremos comparar MVS con un kernel lineal, 
# usando un rago de valores del parámetro `cost`
...
# Realizamos una clasificación usando el mejor modelo ajustado y el conjunto de
# datos de prueba. Luego, mostramos la matriz de confusión
...
# Ajustamos una máquina de vectores de soporte con un kernel radial y valores de
# los parámetros `gamma = 1` y `cost = 1`
...
# Ajustamos una máquina de vectores de soporte con un kernel radial y valores de
# los parámetros `gamma = 1` y `cost = 1e5`
...
# Ajustamos máquinas de vectores de soporte con un kernel radial para diferentes
# valores de los parámetros `cost` y `gamma`
...
# Realizamos clasificación con el mejor modelo ajustado y obtenemos la matriz de
# confusión.
