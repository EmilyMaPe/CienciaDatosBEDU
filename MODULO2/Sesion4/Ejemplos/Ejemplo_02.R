# Ejemplo 2. Teorema central del limite

# Cargamos el paquete ggplot2 para hacer algunas gráficas

library(ggplot2)
# Consideremos una variable aleatoria (v.a.) X con distribucion exponencial y parametro lambda = 2
...
# rep -> repetir 5 muestras de tama?o 3
...
mean(media1000.7); 1/2 # Media de las 1000 medias y media de la poblacion de la cual vienen las 1000 muestras
sd(media1000.7); (1/2)/sqrt(7) # DE de las 1000 medias y DE de la poblacion de la cual vienen las 1000 muestras dividida por la raiz del tama?o de la muestra
...
tail(mdf)
# Observamos que el histograma de las medias es mas parecida todavia a una campana
...
ggplot(mdf, aes(media1000.33)) + 
  ...
  theme_get() +
  theme(plot.title = element_text(hjust = 0.5, size = 16)) 
mean(media1000.33); 1/2 # Media de las 1000 medias y media de la poblacion de la cual vienen las 1000 muestras
sd(media1000.33); (1/2)/sqrt(33) # DE de las 1000 medias y DE de la poblacion de la cual vienen las 1000 muestras dividida por la raiz del tama?o de la muestra
