...
# La siguiente es una base de datos de los libros mas vendidos en Amazon del 2009 - 2019
...
setwd("C:/Users/monts/SantanderBEDU/MODULO2/Sesion1/Data") # Depende del usuario

# La funcion read.csv sera util para leer fichero .csv
...
# Tambien se puede leer el fichero directamente desde una URL

data.url <- read.csv("https://www.football-data.co.uk/mmz4281/2021/SP1.csv")
tail(data.url); str(data.url)

# Calculamos la dimension de la base de datos
