# 2.4 cbind, rbind, manipulacion de DF 

# Funcion cbind

# La funcion cbind toma una sucesion de argumentos que pueden ser 
...
# La funcion rbind funciona de manera similar a cbind, pero en lugar 
