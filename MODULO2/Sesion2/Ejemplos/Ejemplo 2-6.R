...
# Para comenzar necesimos instalar los paquetes `rjson`, y `XML`, por ejemplo, utilizando la funcion
# install.packages. Una vez que hemos instalado los paquetes, podemos cargarlos en `R` mediante la instruccion
