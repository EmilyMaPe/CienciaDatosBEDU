...
[**`Ejemplo 1`**](Ejemplos/notebook_de_practica.ipynb)
...
[**`Ejemplo 2`**](Ejemplos/variables.ipynb)
[**`Reto 1`**](Retos/variables.ipynb)
...
[**`Ejemplo 3`**](Ejemplos/operaciones_numericas.ipynb)
[**`Reto 2`**](Retos/operaciones_numericas.ipynb)
...
[**`Ejemplo 4`**](Ejemplos/tipos_de_datos.ipynb)
...
[**`Ejemplo 5`**](Ejemplos/interpolacion_de_strings.ipynb)
[**`Reto 3`**](Retos/interpolacion_de_strings.ipynb)
...
[**`Ejemplo 6`**](Ejemplos/operadores_de_comparacion.ipynb)
[**`Reto 4`**](Retos/operadores_de_comparacion.ipynb)
...
[**`Ejemplo 7`**](Ejemplos/estructuras_de_control_de_flujo.ipynb)
[**`Reto 5`**](Retos/estructuras_de_control_de_flujo.ipynb)
